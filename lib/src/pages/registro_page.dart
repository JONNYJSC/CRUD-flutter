...
import 'package:prueba_1/src/bloc/login_bloc.dart';
import 'package:prueba_1/src/bloc/provider.dart';
import 'package:prueba_1/src/providers/usuario_provider.dart';
...
class RegistroPage extends StatelessWidget {
  ...
  _register(LoginBloc bloc, BuildContext context) async {
    final info = await usuarioProvider.nuevoUsuario(bloc.username, bloc.email, bloc.password);
